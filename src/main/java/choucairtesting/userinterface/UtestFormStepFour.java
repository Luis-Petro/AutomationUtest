...
public class UtestFormStepFour {
    ...
    public static final Target TEXT_FINAL             = Target.the("Finally").located(By.xpath("//a[@id='laddaBtn']//span"));
    public static final Target FINAL                  = Target.the("Welcome page").located(By.id("mainContent"));
}
