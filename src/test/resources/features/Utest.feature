...
Feature: I as a Utest user
  ...
  Scenario:Verify a successful registration in Utest
    ...
    When   you fill out the registration form
      ...
      | luis       |   Perez    | Petro1994Lucho15Herrera12@lpetro.com | 15-December-1994 |  Spanish    | Montería |        3920   |    Colombia| Windows    | 10                |Spanish       | Samsung       | Galaxy a20   | 9         |  #Hell01994Choucair  |
